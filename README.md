...
Reports are generated by [`src/r2-db2/core/report/service.py`](src/r2-db2/core/report/service.py:1) using `ReportOutputService`. Each analysis produces artifacts in multiple formats:

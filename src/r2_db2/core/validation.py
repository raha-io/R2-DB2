...
def validate_pydantic_models_in_package(package_name: str) -> Dict[str, Any]:
    ...
    Args:
        package_name: Name of the package to validate (e.g., 'r2-db2.core')
...
def check_models_health() -> bool:
    ...
    """
    core_packages = [
        "r2-db2.core.tool.models",
        "r2-db2.core.user.models",
        "r2-db2.core.llm.models",
        "r2-db2.core.storage.models",
        "r2-db2.core.agent.models",
    ]

"""
Agent implementation for the R2-DB2 Agents framework.
...
from r2-db2.core.storage import ConversationStore
from r2-db2.core.llm import LlmService
from r2-db2.core.system_prompt import SystemPromptBuilder
from r2-db2.core.storage import Conversation, Message
from r2-db2.core.llm import LlmMessage, LlmRequest, LlmResponse
from r2-db2.core.tool import ToolCall, ToolContext, ToolResult, ToolSchema
from r2-db2.core.user import User
from r2-db2.core.registry import ToolRegistry
from r2-db2.core.system_prompt import DefaultSystemPromptBuilder
from r2-db2.core.lifecycle import LifecycleHook
from r2-db2.core.middleware import LlmMiddleware
from r2-db2.core.workflow import WorkflowHandler, DefaultWorkflowHandler
from r2-db2.core.recovery import ErrorRecoveryStrategy, RecoveryActionType
from r2-db2.core.enricher import ToolContextEnricher
from r2-db2.core.enhancer import LlmContextEnhancer, DefaultLlmContextEnhancer
from r2-db2.core.filter import ConversationFilter
from r2-db2.core.observability import ObservabilityProvider
from r2-db2.core.user.resolver import UserResolver
from r2-db2.core.user.request_context import RequestContext
from r2-db2.core.agent.config import UiFeature
from r2-db2.core.audit import AuditLogger
...
logger.info("Loaded r2-db2.core.agent.agent module")
...
class Agent:
    ...
    def __init__(
        ...
        if conversation_store is None:
            from r2-db2.integrations.local import MemoryConversationStore

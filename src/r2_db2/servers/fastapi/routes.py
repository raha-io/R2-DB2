"""
FastAPI route implementations for R2-DB2 Agents.
"""
...
def register_chat_routes(
    ...
    @app.post("/api/r2-db2/v2/chat_sse")
    async def chat_sse(
    ...
    @app.websocket("/api/r2-db2/v2/chat_websocket")
    ...
    @app.post("/api/r2-db2/v2/chat_poll")
    async def chat_poll(
        chat_request: ChatRequest, http_request: Request
    ) -> ChatResponse:

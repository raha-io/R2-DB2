...
_STOPWORDS = {
    "the", "a", "an", "of", "for", "in", "on", "by", "to", "from", "and",
    "or", "with", "is", "are", "was", "were", "be", "been", "being",
    "show", "give", "list", "get", "me", "top", "best", "worst", "my",
    "our", "their", "this", "that", "these", "those", "last", "past",
    "over", "under", "how", "many", "much", "what", "which", "when",
    "where", "who", "whom", "number", "count", "total", "sum", "avg",
    "average", "mean", "median", "report", "analysis", "data", "per",
    "each", "all", "any", "some", "more", "less",
}
